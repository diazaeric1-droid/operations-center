...
def render() -> None:
    ...
    st.markdown(
        ...
        "Its 30-day score is a Platt-calibrated probability (out-of-fold AUROC ≈0.99 on "
        "clean synthetic signatures — an upper bound on clean data, not a real-world "
        "claim). Full model card on **Methods & Limitations**.\n"
