...
def render() -> None:
    ...
    if flagged:
        ...
        s1a.metric("Deferred BOPD", f"{alert.get('deferred_bopd', 0):,.1f}")
    ...
    m2.metric("Suspected Mode", diag["suspected_mode"].split("—")[0].strip() or "—")
    ...
    theme.source_note(
        ...
        "oil price and NRI with working interest 1.0 and the AFE component's PV10 "
        "convention. The LLM is optional everywhere and confined to narration.")
